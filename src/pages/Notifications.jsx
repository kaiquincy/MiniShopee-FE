  ...
  return (
    ...
    >
      <HStack justify="space-between" mb={3}>
        <Heading size="md" color={theme.text}>Notifications</Heading>
        <Badge colorPalette="red">{unread} unreads</Badge>
      </HStack>
      ...
      <VStack align="stretch" spacing={3}>
        {displayedList.map(n => {
          ...
          // Custom notification type configuration
            ...
            >
              ...
              <VStack align="start" flex={1} spacing={1}>
                <HStack align="start" spacing={2} mb={1}>
                  <Text fontSize="sm" fontWeight="medium" noOfLines={1} color={theme.text}>
                    {title}
                  </Text>
                  {badgeEl}
                </HStack>
                <Text textAlign="left" fontSize="sm" color={theme.textSecondary}>
                  {message}
                </Text>
        ...
        {list.length === 0 && (
          <VStack spacing={8} py={12} textAlign="center">
            <Box
              ...
              shadow="md"
            >
              <Icon as={LuBell} boxSize={12} color={theme.textMuted} />
            </Box>
            ...
            <VStack spacing={3}>
              ...
              <Text color={theme.textSecondary} fontSize="md" maxW="400px">
